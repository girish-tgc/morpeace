        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-16 mb-12">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              <Link href="/the-experience" className="font-body text-sm text-sky-cream/60 hover:text-sky-cream/90 transition-colors">At Morpeace</Link>
              <Link href="/the-forest" className="font-body text-sm text-sky-cream/60 hover:text-sky-cream/90 transition-colors">The Forest</Link>
              <Link href="/philosophy" className="font-body text-sm text-sky-cream/60 hover:text-sky-cream/90 transition-colors">Philosophy</Link>
              <Link href="/gallery" className="font-body text-sm text-sky-cream/60 hover:text-sky-cream/90 transition-colors">Gallery</Link>
              <Link href="/team" className="font-body text-sm text-sky-cream/60 hover:text-sky-cream/90 transition-colors">The Team</Link>
              <Link href="/reviews" className="font-body text-sm text-sky-cream/60 hover:text-sky-cream/90 transition-colors">Reviews</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <a
              href="https://www.google.com/maps/search/?api=1&query=17.6105128%2C73.9891524"
              target="_blank"
