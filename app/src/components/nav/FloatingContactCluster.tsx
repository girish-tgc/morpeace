    ...
    >
      <div className="flex gap-2 md:hidden pointer-events-auto">
        <a
          ...
          className="inline-flex items-center gap-1.5 rounded-full bg-[#25D366] text-white px-3 py-2 font-display text-[10px] tracking-[0.15em] uppercase shadow-[0_6px_18px_rgba(37,211,102,0.45)] hover:bg-[#1fb558] active:scale-95 transition-all"
        >
        ...
        <a
          ...
          className="inline-flex items-center gap-1.5 rounded-full bg-[#0E7EC0] text-white px-3 py-2 font-display text-[10px] tracking-[0.15em] uppercase shadow-[0_6px_18px_rgba(14,126,192,0.45)] hover:bg-[#016795] active:scale-95 transition-all"
        >
