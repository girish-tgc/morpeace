...
export const NEARBY_PLACES: NearbyPlace[] = [
  ...
  { name: 'Baramotichi Vihir', meta: '17th-c ornate stepwell', featured: true },
  { name: 'Khinditla Ganapati', meta: 'Ganesha shrine in the hill pass', featured: true },
  { name: 'Yavateshwar Temple', meta: 'Hilltop Shiva temple · sunset views', featured: true },
