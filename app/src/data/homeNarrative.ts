...
export const narrativeBeats: NarrativeBeat[] = [
  ...
  },
  {
    id: 'recognition',
    lines: [
      'When his fingers brushed my leaves,',
      'I folded.',
      '',
      'Not in fear.',
      'But in recognition.',
      ...
      '',
      'And in that moment\u2026',
      'something far older than both of us awakened.',
    ],
    background: 'mimosa-pudica-closeup.mp4',
    isVideo: true,
  },
  {
    ...
    lines: [
      ...
      '',
      'but it could come alive again\u2014',
      'if the land was given the chance.',
    ],
    background: 'forest-path.jpeg',
    isVideo: false,
  ...
  },
  {
    id: 'listening',
    lines: [
      'And so, he began to create conditions.',
      '',
  ...
  },
  {
    id: 'truth',
    lines: [
      'What followed was not a promise of beauty.',
      '',
      'But a commitment to something far more demanding:',
      '',
      'Truth.',
      'Measured.',
      'Observed.',
